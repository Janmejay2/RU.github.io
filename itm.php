...
<body>
        ...
        <div class=" header-design pt-4 pl-3  ">
            <div class="toggle ml-4" style="position: absolute;left: 10px">
                <a class="btn btn-primary" data-bs-toggle="offcanvas" href="#offcanvasExample" role="button"
                    aria-controls="offcanvasExample" style=" box-shadow: 2px 2px 2px ; "><i
                        class="fa-solid fa-bars fa-2xl pt-2" style="width: 25px; height: 25px ;border: none; "></i>
                </a>
            </div>
            <div class="text-header" style="color: rgb(145, 35, 35);"> Department Of ITm
            </div>
    ...
    <div class=" container-sm clearfix" id="about">
        <img src="images/Department/IST/ist department.jpg" class="col-md-6 float-md-end mb-3 ms-md-3" alt="..."
            id="img-dept">
        <div id="p-dept">
            <p>The Department of ITM was established under the School of Information and Computer Sciences in the year
                1999, to foster a blend of Information Technology and Management courses. Such a mix of two
                pedagogically different subjects makes it unique in itself.the Department offers post-graduate program
                M.Sc. information technology (M.Sc. IT) in self-financing mode. The full-time teaching faculty are
                supported by four demonstrators, an office assistant, one library assistant and three attendants. The
                faculty have a robust academic and technical background with extensive experience in the software
                industry. The Department owes its success to its technical and infrastructural facilities. The
                Department has its own library with over 5000 titles. All the books in the library have been barcoded,
                and the issue and return of books have been automated. There are nine classrooms with 24 x 7 Wi-Fi
                connectivity. There are well-equipped computer caboratories with 170 systems.Dept. of ITM has a good
                track record of placements every year where several service based companies hire many students from the
                department. Companies like Deloitte,Accenture,Wipro,ICICI bank,HDFC bank recruit students every year.
            </p>
            <p>
    ...
    <div class="container-sm ">
        <h3
            style=" color: rgb(145, 35, 35); text-align: center; font-weight: 600; padding-bottom: 30px; text-transform: uppercase; ">
            Programes offer by Department</h3>
        <div class="container-sm">
            <div class="row mt-4">
                <div class="item text-center features-image сol-12 col-md-6 col-lg-3">
                    <div class="card text-bg-light mb-3"
                        style="max-width: 18rem; width:fit-content;  letter-spacing: 1px; ">
                        <div class="card-header ">UNDER GRADUATION</div>
                        <div class="card-body" style="padding-top: 15px;">
                            <h5 class="card-title">BACHELOR OF SCIENCE</h5>
                            <p class="card-text">
                            <ul
                                style="list-style-type: none; text-align:left; font-size:medium;text-transform: uppercase; padding:10px ;line-height: 150%;">
                                <li> Course name : <strong> ITm</strong></li>
                                <li>NO OF SEATS : 128</li>
                                <li> Course Fee : 42000</li>
                                <li>Duration : 3rd year</li>


                            </ul>
                            <button type="button" class="btn btn-outline-secondary"
                                style="color:black">SYLLABUS</button>
                            </p>
                        </div>
                    </div>
                ...
                <div class="item text-center features-image сol-12 col-md-6 col-lg-3">
                    <div class="card text-bg-light mb-3"
                        style="max-width: 18rem; width:fit-content;  letter-spacing: 1px; ">
                        <div class="card-header ">POST GRADUATION</div>
                        <div class="card-body" style="padding-top: 15px;">
                            <h5 class="card-title">MASTER IN SCIENCE</h5>
                            <p class="card-text">
                            <ul
                                style="list-style-type: none; text-align:left; font-size:medium;text-transform: uppercase; padding:10px ;line-height: 150%;">
                                <li> Course name : <strong> ITm</strong></li>
                                <li>NO OF SEATS : 48</li>
                                <li> Course Fee : 42000</li>
    ...
    <div class="container-sm mt-2">
        ...
        <div class="row mt-4">
            <div class="item features-image сol-12 col-md-6 col-lg-3">
                <div class="card01">
                    <img class="img01" src="Images/Home/Blogs/KSKV.jpeg" alt="Example Image">
                    <div class="card01-text text-center">
                        <h4>Sailaja Sankar Kanungo</h4>
                        <h5 class=" ">HOD </h5>
                        <div class="social pt-2">
                            <a href="sailajasankar123@gmail.com"><i class="fa-solid fa-envelope fa-beat fa-xl"
                                    style="color: #fff;"></i></a>
                            <a href="tel:+91-9937641647"><i class="fa-solid fa-phone fa-beat fa-xl"
                                    style="color: #fff; margin-left: 80px;"></i></a>
            ...
            <div class="item features-image сol-12 col-md-6 col-lg-3">
                <div class="card01">
                    <img class="img01" src="Images/Home/Blogs/KSKV.jpeg" alt="Example Image">
                    <div class="card01-text text-center">
                        <h4>Manas Prasad Rout</h4>
                        <h5 class=" ">Lecturer </h5>
                        <div class="social pt-2">
                            <a href="mprout@ravenshawuniversity.ac.in
                            "><i class="fa-solid fa-envelope fa-beat fa-xl" style="color: #fff;"></i></a>
                            <a href="tel:+91-9861276581"><i class="fa-solid fa-phone fa-beat fa-xl"
                                    style="color: #fff; margin-left: 80px;"></i></a>
            ...
            <div class="item features-image сol-12 col-md-6 col-lg-3">
                <div class="card01">
                    <img class="img01" src="Images/Home/Blogs/KSKV.jpeg" alt="Example Image">
                    <div class="card01-text text-center ">
                        <h4>Santosh Kumar Paul</h4>
                        <h5 class="">Lecturer </h5>
                        <div class="social pt-2">
                            <a href="paulsantosh2003@yahoo.co.in"><i class="fa-solid fa-envelope fa-beat fa-xl"
                                    style="color: #fff;"></i></a>
                            <a href="tel:+91-9846739015"><i class="fa-solid fa-phone fa-beat fa-xl"
                                    style="color: #fff; margin-left: 80px;"></i></a>
            ...
            <div class="item features-image сol-12 col-md-6 col-lg-3">
                <div class="card01">
                    ...
                    <div class="card01-text text-center">
                        ...
                        <h5 class=" ">Lecturer </h5>
                        <div class="social pt-2">
                            <a href="priyanka2002@yahoo.com"><i class="fa-solid fa-envelope fa-beat fa-xl"
                                    style="color: #fff;"></i></a>
                            <a href="tel:+91-9853875106"><i class="fa-solid fa-phone fa-beat fa-xl"
                                    style="color: #fff; margin-left: 80px;"></i></a>
            ...
            <div class="item features-image сol-12 col-md-6 col-lg-3">
                <div class="card01">
                    <img class="img01" src="Images/Home/Blogs/KSKV.jpeg" alt="Example Image">
                    <div class="card01-text text-center">
                        <h4>Ratikanta Biswal</h4>
                        <h5 class=" ">Lecturer </h5>
                        <div class="social pt-2">
                            <a href=" rimun143@gmail.com"><i class="fa-solid fa-envelope fa-beat fa-xl"
                                    style="color: #fff;"></i></a>
                            <a href="tel:+91-8709917689"><i class="fa-solid fa-phone fa-beat fa-xl"
                                    style="color: #fff; margin-left: 80px;"></i></a>
            ...
            <div class="item features-image сol-12 col-md-6 col-lg-3">
                <div class="card01">
                    <img class="img01" src="Images/Home/Blogs/KSKV.jpeg" alt="Example Image">
                    <div class="card01-text text-center">
                        <h4>Debasish Kanungo</h4>
                        <h5 class=" ">Lecturer </h5>
                        <div class="social pt-2">
                            <a href="debasish.hhadept@gmail.com"><i class="fa-solid fa-envelope fa-beat fa-xl"
                                    style="color: #fff;"></i></a>
                            <a href="tel:+91-9489045744"><i class="fa-solid fa-phone fa-beat fa-xl"
                                    style="color: #fff; margin-left: 80px;"></i></a>
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="tab-pane fade" id="code10" role="tabpanel" aria-labelledby="code10-tab" tabindex="0">
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-md-3">
                                        <a href="https://drive.google.com/file/d/1-UFAVADh1FnN8P7353T7r82d1-D0zV61/view?usp=share_link" style=" text-decoration: none;color: black;font-size: x-large;">
                                            <div class="cs-card"> 2021
                                            </div>
                                        </a>
                                    </div>
                            ...
                            <div class="tab-pane fade" id="code12" role="tabpanel" aria-labelledby="code12-tab" tabindex="0">
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-md-3">
                                        <a href="https://drive.google.com/file/d/1-OPcy9UMCGjqTjI-UhjQGVp3acOo_Vt8/view?usp=share_link" style=" text-decoration: none;color: black;font-size: x-large;">
                                            <div class="cs-card"> 2022
                                            </div>
                                        </a>
                                    </div>
                            ...
                            <div class="tab-pane fade" id="code13" role="tabpanel" aria-labelledby="code13-tab" tabindex="0">
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-md-3">
                                        <a href="https://drive.google.com/file/d/1-JwMguTNjpTkmWXfG5neYkhTgb56Yj9t/view?usp=share_link" style=" text-decoration: none;color: black;font-size: x-large;">
                                            <div class="cs-card"> 2022
                                            </div>
                                        </a>
                                    </div>
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                ...
                                <div class="tab-pane fade" id="code14" role="tabpanel" aria-labelledby="code14-tab" tabindex="0">
                                    ...
                                    <div class="row ">
                                        ...
                                        <div class="col-md-3">
                                            <a href="https://drive.google.com/file/d/1-yA5kF-F_dRaZhZxjwhPVdWO0N7h6N3R/view?usp=share_link" style=" text-decoration: none;color: black;font-size: x-large;">
                                                <div class="cs-card"> 2022
                                                </div>
                                            </a>
                                        </div>
                                ...
                                <div class="tab-pane fade" id="code15" role="tabpanel" aria-labelledby="code15-tab" tabindex="0">
                                    ...
                                    <div class="row ">
                                        ...
                                        <div class="col-md-3">
                                            <a href="https://drive.google.com/file/d/1-d4g09nLK8dE7Lrvy-whrgAUS5CZbt-i/view?usp=share_link" style=" text-decoration: none;color: black;font-size: x-large;">
                                                <div class="cs-card"> 2022
                                                </div>
                                            </a>
                                        </div>
                                ...
                                <div class="tab-pane fade" id="code16" role="tabpanel" aria-labelledby="code16-tab" tabindex="0">
                                    ...
                                    <div class="row ">
                                        ...
                                        <div class="col-md-3">
                                            <a href="https://drive.google.com/file/d/1-vLA9iHOcNgeB3e6C9dOlVzqz3FjkIOW/view?usp=share_link" style=" text-decoration: none;color: black;font-size: x-large;">
                                                <div class="cs-card"> 2022
                                                </div>
                                            </a>
                                        </div>
                                ...
                                <div class="tab-pane fade" id="code17" role="tabpanel" aria-labelledby="code17-tab" tabindex="0">
                                    ...
                                    <div class="row ">
                                        ...
                                        <div class="col-md-3">
                                            <a href="https://drive.google.com/file/d/10A4ZW4IS_YQO6dE0d0CLp833_3eHMwEa/view?usp=share_link" style=" text-decoration: none;color: black;font-size: x-large;">
                                                <div class="cs-card"> 2022
                                                </div>
                                            </a>
                                        </div>
                                ...
                                <div class="tab-pane fade" id="code18" role="tabpanel" aria-labelledby="code18-tab" tabindex="0">
                                    ...
                                    <div class="row ">
                                        ...
                                        <div class="col-md-3">
                                            <a href="https://drive.google.com/file/d/105BNeSFn3-VzT7nnCauw7ucY4hcXAqnK/view?usp=share_link" style=" text-decoration: none;color: black;font-size: x-large;">
                                                <div class="cs-card"> 2022
                                                </div>
                                            </a>
                                        </div>
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                ...
                                <div class="tab-pane fade" id="code22" role="tabpanel" aria-labelledby="code22-tab" tabindex="0">
                                    ...
                                    <div class="row ">
                                        ...
                                        <div class="col-md-3">
                                            <a href="https://drive.google.com/file/d/1-EqNq-28fQQpQcG8CNVblM2-ZV9alG5L/view?usp=share_link" style=" text-decoration: none;color: black;font-size: x-large;">
                                                <div class="cs-card"> 2022
                                                </div>
                                            </a>
                                        </div>
